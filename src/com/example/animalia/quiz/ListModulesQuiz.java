...
public class ListModulesQuiz extends Activity {
	...
	public void imageClicked(View view) {
		...
		case R.id.img0:
			...
			i.putExtra("module", modulesList.get(0).get(TAG_MODULE));
			startActivity(i);
			break;
		case R.id.img1:
			i = new Intent(this, QuestionActivity.class);
			i.putExtra("module", modulesList.get(1).get(TAG_MODULE));
			startActivity(i);
			break;
		case R.id.img2:
			i = new Intent(this, QuestionActivity.class);
			i.putExtra("module", modulesList.get(2).get(TAG_MODULE));
			startActivity(i);
			break;
		case R.id.img3:
			i = new Intent(this, QuestionActivity.class);
			i.putExtra("module", modulesList.get(3).get(TAG_MODULE));
			startActivity(i);
			break;
		case R.id.img4:
			i = new Intent(this, QuestionActivity.class);
			i.putExtra("module", modulesList.get(4).get(TAG_MODULE));
			startActivity(i);
			break;
		}
	}
