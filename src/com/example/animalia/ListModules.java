...
public class ListModules extends Activity {
		...
		if (jsonStr != null) {
			try {
				...
				for (int i = 0; i < modules.length(); i++) {
					...
					animal.put(
							TAG_ICON,
							"http://kids.sandiegozoo.org/sites/default/files/imagecache/animal_class_hero/t96-646-4_0.jpg");
	...
	/*	ListAdapter adapter = new SimpleAdapter(ListModules.this, modulesList,
				R.layout.modules_list_item,
				new String[] { TAG_MODULE, TAG_TEXT }, new int[] { R.id.module,
						R.id.text }); */
